...
export const CONSOLE_COMMANDS: readonly ConsoleCommand[] = [
  {
    ...
    aliases: ["go to missions", "missions", "go to runs", "open runs", "show runs", "runs"],
    run: go("/runs"),
  ...
  },
  {
    ...
    group: console_.palette.groupNavigate,
    aliases: ["demo mission", "example run", "open example", "show me an example"],
    run: go("/runs/example"),
  ...
  },
  {
    ...
    group: console_.palette.groupNavigate,
    aliases: ["network", "system health", "readiness", "system", "health"],
    run: go("/system"),
  ...
  },
  {
    ...
    group: console_.palette.groupNavigate,
    aliases: ["guardrails", "policies", "policy", "go to policies"],
    run: go("/policies"),
  ...
  },
  {
    ...
    group: console_.palette.groupNavigate,
    aliases: ["agents", "counterparties", "counterparty", "providers"],
